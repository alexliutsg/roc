...
<script>
setTimeout(function(){
   window.location.replace("http://roctrial.sportsontheweb.net/?page_id=59");
}, 500);
</script>
</head>
...
<body>
	...
	<div class="page-content">
		...
		$sql = "INSERT INTO `1823734_1023`.`participants` (`school_id`,`name`,`gender`,`age`,`remarks`) VALUES (1,'".$_POST["name"]."','".$_POST["sex"]."',".$_POST["age"].",'".$_POST["remarks"]."')";
