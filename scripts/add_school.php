...
<body>
	...
	<div class="page-content">
		...
		//echo "Connected successfully";	
                ...
                $wpdb->insert( 'schools', $data );
                
                
		//$sql = "INSERT INTO `1823734_1023`.`schools` (`region_id`,`primary_name`,`alternative_names`,`address`,`contact_numbers`,`email`,`fax_numbers`,`website`,`contact_persons`,`title`,`pitching_status`,`remarks`) VALUES ('".$_POST["region_id"]."','".$_POST["primary_name"]."','".$_POST["alternative_names"]."','".$_POST["address"]."','".$_POST["contact_numbers"]."','".$_POST["email"]."','".$_POST["fax_numbers"]."','".$_POST["website"]."','".$_POST["contact_persons"]."','".$_POST["title"]."','UNPITCHED','".$_POST["remarks"]."')";
