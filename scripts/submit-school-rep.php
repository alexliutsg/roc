...
<body>
	...
	<div class="page-content">
		...
		$sql = "UPDATE `1823734_1023`.`schools` SET `contact_persons`='".$_POST["name"]."',`title`='".$_POST["title"]."',`contact_numbers`='".$_POST["phone"]."',`email`='".$_POST["email"]."',`fax_numbers`='".$_POST["fax"]."' WHERE id=1";
