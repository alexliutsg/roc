...
if (theme_get_option('theme_override_default_footer_content')) {
    ...
    theme_add_sidebar('footer', 'footer-1-widget-area', __('Footer 1 Widget Area', THEME_NS), __("The custom footer widget area.", THEME_NS));
    theme_add_sidebar('footer', 'footer-2-widget-area', __('Footer 2 Widget Area', THEME_NS), __("The custom footer widget area.", THEME_NS));
}
