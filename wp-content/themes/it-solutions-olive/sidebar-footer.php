...
<div class="art-content-layout">
    <div class="art-content-layout-row">
    <div class="art-layout-cell layout-item-0" style="width: 50%"><?php if (false === theme_print_sidebar('footer-1-widget-area')) { ?>
        <p>Copyright © 2014</p>
    <?php } ?></div><div class="art-layout-cell layout-item-0" style="width: 50%"><?php if (false === theme_print_sidebar('footer-2-widget-area')) { ?>
